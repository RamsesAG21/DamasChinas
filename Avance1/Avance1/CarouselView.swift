...
class CarouselView: UIView {
    ...
    struct CarouselData {
        ...
        private lazy var carouselCollectionView: UICollectionView = {
            ...
            collection.register(CollectionViewCellCarousel.self, forCellWithReuseIdentifier: CollectionViewCellCarousel.cellId)
    ...
    extension CarouselView: UICollectionViewDataSource {
        ...
        func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
            guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: CollectionViewCellCarousel.cellId, for: indexPath) as? CollectionViewCellCarousel else { return UICollectionViewCell() }
